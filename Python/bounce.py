...
ball1 = BouncingBall(int(SCREEN_WIDTH/2),int(SCREEN_HEIGHT/2),random.randint(-10,10),random.randint(-10,10),random.randint(20,80))
ball2 = BouncingBall(int(SCREEN_WIDTH/2),int(SCREEN_HEIGHT/2),random.randint(-10,10),random.randint(-10,10),random.randint(20,80))
ball3 = BouncingBall(int(SCREEN_WIDTH/2),int(SCREEN_HEIGHT/2),random.randint(-10,10),random.randint(-10,10),random.randint(20,80))
ball4 = BouncingBall(int(SCREEN_WIDTH/2),int(SCREEN_HEIGHT/2),random.randint(-10,10),random.randint(-10,10),random.randint(20,80))
ball5 = BouncingBall(int(SCREEN_WIDTH/2),int(SCREEN_HEIGHT/2),random.randint(-10,10),random.randint(-10,10),random.randint(20,80))
